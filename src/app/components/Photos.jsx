...
const Photos = () => {
  ...
  const title = 'See How We Make Our Clients Perfect'
  ...
  return (
    <div className="w-full px-6 md:px-28 py-16 bg-[#EFE6DF]">
      {/* Heading */}
      ...
      <div ref={ref} className="flex gap-6 overflow-x-auto scrollbar-hide pb-4 no-scrollbar py-8">
        {num.map((item, index) => (
          ...
          className="lg:min-w-[450px] lg:h-[550px] min-w-[200px] h-[300px] relative rounded-xl overflow-hidden flex-shrink-0 border-[#C8102E]">
