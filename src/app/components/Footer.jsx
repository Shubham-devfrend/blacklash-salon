...
const Footer = () => {
  return (
    <footer className="bg-[#EFE6DF] text-[#1a1a1a] px-6 md:px-16 lg:px-32 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 border-b border-gray-700 pb-8">
        ...
        <div>
          ...
          <Image src='/logo.webp' alt='logo' width={70} height={100} className='rounded-full'/>
          <p className="text-neutral-700 mb-4 py-2">Elevate Movement. Embody Artistry.</p>
          <div className="flex gap-4">
            <a href="#" className="bg-[#e7ab49] p-3 rounded-full text-white hover:bg-yellow-600 transition">
              <FaInstagram />
            </a>
            <a href="#" className="bg-[#e7ab49] p-3 rounded-full text-white hover:bg-yellow-600 transition">
              <FaFacebookF />
        ...
        <div>
          ...
          <div className="flex items-start gap-2 text-neutral-700 mb-2">
            ...
            <p>Fort Wayne, IN, United States</p>
          </div>
          <p className="text-neutral-700 mt-2">+1 260-387-0565</p>
        </div>
        ...
        <div>
          ...
          />
          <button className="bg-[#e7ab49] text-white font-semibold w-full py-2 rounded-md transition">
            Subscribe
          </button>
        </div>
      </div>
